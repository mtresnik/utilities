...
public class CountObject<T> {
    ...
    static {
        ...
        AMOUNT_COMPARATOR = Comparator.comparingInt(CountObject::getAmount);
    }
    ...
    public Function2<CountObject<T>, Object, Boolean> getEqualsFunction() {
        return equalsFunction;
    }

    public void setEqualsFunction(Function2<CountObject<T>, Object, Boolean> equalsFunction) {
        this.equalsFunction = equalsFunction;
    }

    public static <T> Boolean equalsOther(CountObject<T> tCountObject, Object obj){
        if (tCountObject == obj) {
            return true;
        }
        if (tCountObject == null) {
            return false;
        }
        if (tCountObject.getClass() != obj.getClass()) {
            return false;
        }
        final CountObject<?> other = (CountObject<?>) obj;
        if (!Objects.equals(tCountObject.identifiableElement, other.identifiableElement)) {
            return false;
        }
        return true;
    }

    public final Function2<CountObject<T>, Object, Boolean> DEFAULT_EQUALS_FUNCTION = CountObject::equalsOther;

    public Function2<CountObject<T>, Object, Boolean> equalsFunction = DEFAULT_EQUALS_FUNCTION;
    @Override
    public boolean equals(Object obj) {
        return equalsFunction.invoke(this, obj);
    }
