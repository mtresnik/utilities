...
public class ConvexHull {
    ...
    public ConvexHull(List<PolygonPoint> points) {
        ...
        midX = (maxX + minX) / 2.0;
        midY = (maxY + minY) / 2.0;
        System.out.println(Arrays.asList(minX, midX, maxX, minY, midY, maxY));
        thetaMap = new LinkedHashMap();
        edgeMap = new LinkedHashMap();
        this.basePoints = points;
        this.initThetaMap();
        System.out.println(this.thetaMap);
    }
    ...
    private void initThetaMap() {
        ...
        for(PolygonPoint currPoint : this.edgePoints){
            System.out.println(currPoint + "\t" + this.getTheta(currPoint));
        }
        System.out.println(Arrays.asList(minTheta, maxTheta) + "\t" + Arrays.asList(minDist, maxDist));
        System.out.println(this.edgePoints);
