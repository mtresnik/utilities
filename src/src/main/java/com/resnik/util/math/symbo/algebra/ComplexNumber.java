package com.resnik.util.math.symbo.algebra;
...
import com.resnik.util.math.symbo.algebra.parse.ParseException;
...
public class ComplexNumber
    ...
    public static ComplexNumber atan(ComplexNumber z){
        ComplexNumber front = ComplexNumber.I.divide(ComplexNumber.TWO);
        ComplexNumber num = I.add(z);
        ComplexNumber denom = I.subtract(z);
        ComplexNumber back = complexLn(num.divide(denom));
        return front.multiply(back);
    }

    public static ComplexNumber aTan(double x){
        return ComplexNumber.a(Math.atan(x));
    }
